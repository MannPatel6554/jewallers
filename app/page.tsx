      ...
      >
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xs sm:text-sm text-[var(--text-secondary)] mb-6">
            Explore our premium imitation jewellery collection from the comfort of your home.
          </p>
          ...
          <p className="mb-6 text-xs sm:text-sm text-[var(--text-muted)]">
            💬 For product enquiries, availability & orders, connect with us on WhatsApp and Home.
          </p>

          <div className="flex flex-col sm:flex-row flex-wrap gap-3 justify-center items-center max-w-xs sm:max-w-none mx-auto">
            <a
